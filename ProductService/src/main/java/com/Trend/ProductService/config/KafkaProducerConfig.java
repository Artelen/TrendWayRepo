...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, PriceChangeEvent> producerFactoryPriceChangeEvent() {
    ...
    @Bean
    public KafkaTemplate<String, PriceChangeEvent> kafkaTemplatePriceChangeEvent() {
        return new KafkaTemplate<>(producerFactoryPriceChangeEvent());
    }
